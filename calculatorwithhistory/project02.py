"""
Input (input()) == To get the users operation or command

functions == To organize code (calculating ,showing history ,etc.)

Conditionals == To decide what to do : calculation , history ,or clear 

File handling == To saveload/clear history in a .txt file 

loops (while) == To keep the program running until user exits 
